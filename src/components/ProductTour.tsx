...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Start on free remixes. When you\'re ready for more — no watermark, more remixes, analytics — open your plan, compare them side by side, and add a card in seconds.",
