...
import {
  ...
  FileText, Sparkles, Star, TrendingUp, Mic, BarChart3, ChevronRight,
} from 'lucide-react'
...
// Hero video — generated by Higgsfield Seedance 2.0
...
const ROTATING_VERBS = ['recreate', 'own', 'outperform', 'publish']
...
const PLATFORMS = [
  { label: 'TikTok', color: 'from-[#010101] to-[#69C9D0]', text: 'text-white' },
  { label: 'Instagram', color: 'from-[#833ab4] via-[#fd1d1d] to-[#fcb045]', text: 'text-white' },
  { label: 'YouTube', color: 'from-[#FF0000] to-[#cc0000]', text: 'text-white' },
  { label: 'Twitter / X', color: 'from-[#14171A] to-[#333]', text: 'text-white' },
  { label: 'LinkedIn', color: 'from-[#0077B5] to-[#005885]', text: 'text-white' },
]
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-content px-5 pb-20 pt-28 sm:pt-32 lg:pt-36">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 rounded-full border border-white/12 bg-white/5 px-4 py-1.5 text-xs text-sand backdrop-blur"
        >
          <span className="relative flex h-2 w-2">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-teal opacity-60" />
            <span className="relative h-2 w-2 rounded-full bg-teal shadow-[0_0_10px_3px_rgba(101,229,216,.6)]" />
          </span>
          {BRAND.category} · Early access open
        ...
        <div className="mt-8 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            >
              You scroll past a video with millions of views and think{' '}
              <em className="not-italic text-cream">"I could've made that."</em>{' '}
              Paste the link. TwinAI decodes it, scripts it in your voice, films it with you,
              edits in one click, and posts it.{' '}
              <span className="text-cream">The whole loop — one window.</span>
            </motion.p>
            ...
            >
              <Link to="/auth" className="btn-gradient group text-base px-6 py-3">
            ...
            >
              ...
              <span className="inline-flex items-center gap-1.5">
                <Zap className="h-4 w-4 text-amber" /> Blueprint in ~30s
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Check className="h-4 w-4 text-stone" /> No card required
              </span>
            </motion.div>
          </div>
    ...
    >
      <div className="relative">
        ...
        <motion.div
          ...
          className="absolute -left-20 top-8 x-20 w-48 rounded-2xl border border-white/12 bg-ink2/90 p-3.5 shadow-lift backdrop-blur"
        >
        ...
        <motion.div
          ...
          className="relative w-[210px] overflow-hidden rounded-[42px] border-[5px] border-white/15 bg-ink shadow-[0_32px_90px_-16px_rgba(0,0,0,.8)]"
        ...
        >
          ...
          <div className="relative h-[380px] overflow-hidden bg-gradient-to-b from-coral/30 via-ink2 to-ink">
            {/* Rec indicator */}
        ...
        <motion.div
          ...
          className="absolute -right-10 bottom-28 z-20 rounded-2xl bg-signature px-3.5 py-2 text-xs font-bold text-ink shadow-glow"
        >
          In your voice ✦
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute -left-14 bottom-20 z-20 space-y-1.5 rounded-2xl border border-white/10 bg-ink2/90 p-3 shadow-lift backdrop-blur text-[10px]"
        >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {PLATFORMS.map((p) => (
            <div
              key={p.label}
              className={cn(
                'inline-flex items-center gap-2 rounded-full bg-gradient-to-r px-4 py-2 text-xs font-bold shadow-md transition-transform hover:scale-105',
                p.color, p.text,
              )}
            >
              {p.label}
    ...
    <section className="mx-auto max-w-content px-5 py-12 sm:py-16">
      <Reveal className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-xs text-stone">
          Representative of early-access creators while we gather public results.
        </p>
      </Reveal>
      <Stagger className="mt-14 grid gap-5 md:grid-cols-3" gap={0.08}>
        {SOCIAL_PROOF.map((s) => (
      ...
      <Reveal className="relative overflow-hidden rounded-panel border border-white/10 px-6 py-24 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="mx-auto mt-4 max-w-md text-sand">
            2 free recreations. No card. Blueprint in ~30 seconds. The whole loop — one window.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <Link to="/auth" className="btn-gradient group text-base px-8 py-4">
              Start free — no card
              <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" />
            </Link>
            <a href="#pricing" className="btn-ghost text-base px-8 py-4">See pricing</a>
          </div>
          <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-stone">
            <span className="inline-flex items-center gap-1.5">
    ...
    <footer className="border-t border-white/8 bg-ink2/40">
      <div className="mx-auto grid max-w-content gap-10 px-5 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-sand">
            <li><Link to="/auth" className="hover:text-cream transition-colors">Start free</Link></li>
            <li><Link to="/auth" className="hover:text-cream transition-colors">Sign in</Link></li>
