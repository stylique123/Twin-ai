// Capture helpers shared by the record surfaces (V1 Record + V2 Capture) and the
// edit-poll surfaces (V1 Record, V2 Review). Extracted so the MediaRecorder MIME
// selection and the "poll a queued edit job to completion" loop live in ONE place
